...
<body>
 ...
 <center><h3>BOOKING LIST</h3></center>
    ...
    $sql="SELECT tickettable.busid,ticid,customertable.custfname,bustable.drivername,bustable.vecnum,
                 ...
                 FROM `tickettable` INNER JOIN bustable ON tickettable.busid=bustable.busid INNER JOIN customertable ON tickettable.custid=customertable.custid where status='Booked'";
